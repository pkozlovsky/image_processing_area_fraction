...
class ImageProcessorManager:
        ...
        for filename in os.listdir(self.input_dir):
            if filename.lower().endswith(('.bmp', '.jpg', '.png')):
                ...
                for i, segment in enumerate(splitter.segments):
                    ...
                    self.black_area_percentages.append(((filename, i+1), processor.black_area_percentage, black_area_um2, self.segment_area_um2, black_area_volume_um3))
    ...
    def save_percentages_to_csv(self):
        ...
        with open(csv_file_path, 'w', newline='') as csvfile:
            fieldnames = ['segment_name', 'segment_number', 'percentage', 'black_area_um2', 'total_area_um2', 'black_area_volume_um3']
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
            writer.writeheader()
            for segment_info, percentage, black_area_um2, total_area_um2, black_area_volume_um3 in self.black_area_percentages:
