...
class ImageProcessorManager:
    ...
    def process_images(self):
        ...
        for filename in os.listdir(self.input_dir):
            if filename.lower().endswith(('.bmp', '.jpg', '.png')):
                ...
                for i, segment in enumerate(splitter.segments):
                    ...
                    # Calculate Kxy for each segment
                    Kxy = (black_area_volume_um3 / total_volume_um3) * self.K_copper + (1 - black_area_volume_um3 / total_volume_um3) * self.K_dielectric
                    ...
                    self.dataframe_data['layer_thickness_um'].append(layer_thickness)  # Ensure this line is added if not already
                    self.dataframe_data['Kxy'].append(Kxy)  # Add Kxy value for each segment
        ...
        self.calculate_effective_Kz()  # Ensure this is called after processing
